...
import { deepclone } from 'ferrum';
import _ from 'lodash';
// eslint-disable-next-line import/no-named-default
import { default as debug, DEBUG_TEMPLATE } from '../src/html/output-debug.js';
...
describe('Test outputDebug', () => {
  ...
  function computeExpectedOutput(context) {
    ...
    const debugScript = DEBUG_TEMPLATE.replace(/CONTEXT_JSON/, JSON.stringify(p));
