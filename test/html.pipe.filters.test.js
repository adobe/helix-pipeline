...
describe('Testing HTML Pipeline (Filters)', () => {
  setupPolly({
    recordIfMissing: false,
  });

  it('html.pipe renders broken filters correctly', async () => {
    const result = await pipe(
      ...
      },
      {
        request: crequest,
        content: {
          body: fs.readFileSync(path.resolve(__testdir, 'fixtures/broken-filters.md')).toString(),
        },
      },
      {
        request: {
